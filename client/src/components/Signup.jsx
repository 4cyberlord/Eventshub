    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary-600 to-secondary-600 p-12 relative overflow-hidden">
        <div className="relative z-10 flex flex-col justify-between h-full">
          <div>
            <h1 className="text-4xl font-bold text-white mb-6">Join EventMaster Today</h1>
            <p className="text-primary-100 text-lg mb-8 leading-relaxed">
              Create and manage events like never before. Join thousands of event organizers 
              who trust EventMaster for their event management needs.
            </p>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
            <p className="text-white/90 italic mb-4">
              "Since joining EventMaster, our event attendance has increased by 60%. 
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-primary-200 text-sm">Community Manager @ EventPro</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-gray-900">
        <div className="w-full max-w-md space-y-8 animate-fade-in">
          <div className="text-center">
            ...
            <p className="mt-3 text-gray-400">Start your journey with EventMaster</p>
          </div>
