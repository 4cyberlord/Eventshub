    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary-600 to-secondary-600 p-12 relative overflow-hidden">
        <div className="relative z-10 flex flex-col justify-between h-full">
          <div>
            <h1 className="text-4xl font-bold text-white mb-6">Welcome to EventMaster</h1>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
            <p className="text-white/90 italic mb-4">
              "EventMaster has revolutionized how we organize our tech conferences. 
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="text-white font-medium">Bernard</p>
                <p className="text-primary-200 text-sm">Event Director @ TechConf</p>
              </div>
            </div>
          </div>
        </div>

        {/* Keep the decorative background elements */}
